...
const Dashboard = () => {
  ...
  return (
    <div style={{ padding: "30px", fontFamily: "Arial, sans-serif" }}>
      ...
      {/* Featured Book Animation Banner */}
      <div
        style={{
          marginBottom: "30px",
      ...
      >
        <h2 style={{ fontSize: "28px", marginBottom: "10px" }}>📚 Featured Book</h2>
        <p style={{ fontSize: "18px" }}>Discover our top recommended read of the week!</p>
      </div>
